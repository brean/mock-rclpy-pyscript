...
Invalid {name_type}: {error_msg}:
  '{name}'
   {indent}^\
""".format(
            name_type=name_type, name=name, error_msg=error_msg,
            indent=' ' * invalid_index)
...
class InvalidNamespaceException(NameValidationException):
    ...
    def __init__(self, name, error_msg, invalid_index, *args):
        NameValidationException.__init__(
            self, 'namespace', name, error_msg, invalid_index)
...
class InvalidNodeNameException(NameValidationException):
    ...
    def __init__(self, name, error_msg, invalid_index, *args):
        NameValidationException.__init__(
            self, 'node name', name, error_msg, invalid_index)
...
class InvalidTopicNameException(NameValidationException):
    ...
    def __init__(self, name, error_msg, invalid_index, *args):
        NameValidationException.__init__(
            self, 'topic name', name, error_msg, invalid_index)
...
class InvalidServiceNameException(NameValidationException):
    ...
    def __init__(self, name, error_msg, invalid_index, *args):
        NameValidationException.__init__(
            self, 'service name', name, error_msg, invalid_index)
...
class ParameterNotDeclaredException(ParameterException):
    ...
    def __init__(self, parameters, *args):
        Exception.__init__(
            self, 'Invalid access to undeclared parameter(s)',
            parameters, *args)
...
class ParameterAlreadyDeclaredException(ParameterException):
    ...
    def __init__(self, parameters, *args):
        Exception.__init__(
            self, 'Parameter(s) already declared', parameters, *args)
...
class InvalidParameterTypeException(ParameterException):
    ...
    def __init__(self, desired_parameter, expected_type, *args):
        ...
        name = Parameter.Type.from_parameter_value(
            desired_parameter._value).name
        Exception.__init__(
            self,
            f"Trying to set parameter '{desired_parameter._name}' to '"
            f"{desired_parameter._value}' of type '"
            f"{name}', expecting type '{expected_type}'",
            *args)
...
class InvalidParameterValueException(ParameterException):
    """Raised when a parameter is rejected by a user callback or when
    ...
    def __init__(self, parameter, value, reason, *args):
        Exception.__init__(
            ...
            '({value}) for parameter. Reason: {reason}'.format(
...
class ParameterImmutableException(ParameterException):
    ...
    def __init__(self, parameter, *args):
        Exception.__init__(
            self, 'Attempted to modify read-only parameter', parameter, *args)
